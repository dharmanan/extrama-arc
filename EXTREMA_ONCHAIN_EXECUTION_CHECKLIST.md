...
- [x] Gateway deposit recovery disposition separates active resume from uncertain reconciliation
  ...
  - Status: **IMPLEMENTED / DETERMINISTICALLY VALIDATED**. The preserved Arbitrum action remains approval-only **LIVE PROVEN**; its deposit submission and Gateway credit/finality remain **NOT LIVE PROVEN**.
