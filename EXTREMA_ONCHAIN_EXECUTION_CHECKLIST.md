...
- Responsive layout: four cards in one row on a desktop, two by two at medium widths, one column on a phone. Borders, type and spacing only, in the existing editorial style; no bright colors and no dashboard-style filled tiles.
