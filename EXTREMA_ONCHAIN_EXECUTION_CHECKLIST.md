...
- Current outbound destination matrix: Arc Testnet, Base Sepolia and OP Sepolia are **FULLY LIVE PROVEN as Gateway destinations**; Arbitrum Sepolia and Ethereum Sepolia remain **NOT LIVE PROVEN as Gateway destinations**. General outbound proof remains **OPEN** until each remaining destination receives its own controlled normal-UI proof.
