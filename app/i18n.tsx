...
export const copy = {
  en: {
    ...
    beforeMarket period: "before observation",
    closes: "Closes",
    ...
    result: {
      ...
      progressMarket period: "Market period",
      progressSettlement: "Settlement",
      progressSettlementBody: "Pending until observation completes",
    ...
    verify: {
      ...
      readinessMarket period: "Market period",
      ...
      cancelledBody: "This round was cancelled. Settlement verification does not apply.",
  ...
  tr: {
    ...
    beforeMarket period: "dönem bitmeden önce",
    closes: "Kapanış",
    ...
    result: {
      ...
      progressMarket period: "Piyasa dönemi",
    ...
    verify: {
      ...
      readinessMarket period: "Piyasa dönemi",
