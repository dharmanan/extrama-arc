...
export const copy = {
  en: {
    ...
    verify: {
      ...
      observationEnds: "Observation ends",
      resolvedPrice: "Resolved price",
      source: "Source",
      window: "Window",
      extremum: "Extremum",
  ...
  tr: {
    ...
    result: {
      ...
      progressObservation: "Gözlem",
      progressSettlement: "Kesinleşme",
      progressSettlementBody: "Gözlem tamamlanana kadar bekliyor",
    ...
    verify: {
      ...
      pool: "Havuz",
      observationWindow: "Gözlem penceresi",
